...
Base = 'http://sertelu.blogspot.com/2016/04/addon-prueba.html' #    modificar("la ruta de tus listas")

addon = xbmcaddon.Addon('plugin.video.CHAWYTV') #    modificar("el nombre de tu addons")
